				...
				<div class="sb-sidenav-menu">
					...
					<div class="menu">
						<ul>
							...
							<li><a href="communityMain?mem_id=<%=vo.getMem_id() %>" class="sb-menu sb-menu1""> 게시판 </a></li>
							<li><a href="ViewLocation?mem_id=<%=vo.getMem_id() %>" class="sb-menu sb-menu2""> 실시간 </a></li>
